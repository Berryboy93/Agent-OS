...
- Name: dashboard.spec.ts >> Backend API >> GET /api/stats → 200 + required fields
- Location: e2e/dashboard.spec.ts:152:3
...
Expected path: "active_agents"
Received path: []

Received value: {"active_pipelines": 1, "pending_approvals": 2, "success_rate": 50, "total_deployments": 2, "total_runs": 4}
```
