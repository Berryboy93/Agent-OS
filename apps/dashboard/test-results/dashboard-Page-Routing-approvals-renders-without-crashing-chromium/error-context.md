...
- Name: dashboard.spec.ts >> Page Routing >> /approvals renders without crashing
- Location: e2e/dashboard.spec.ts:42:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5173/approvals
Call log:
  - navigating to "http://127.0.0.1:5173/approvals", waiting until "load"
