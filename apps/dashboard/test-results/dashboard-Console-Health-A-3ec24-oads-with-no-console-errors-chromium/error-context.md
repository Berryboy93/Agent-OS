...
- Name: dashboard.spec.ts >> Console Health >> Agents page loads with no console errors
- Location: e2e/dashboard.spec.ts:288:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5173/agents
Call log:
  - navigating to "http://127.0.0.1:5173/agents", waiting until "load"
