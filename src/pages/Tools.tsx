              ...
              <AnimatePresence>
                {tools.map(tool => {
                  ...
                  return (
                    ...
                    >
                      <GlassPanel className="p-5 h-full hover:border-cyan-500/30 transition-all cursor-pointer" onClick={() => setSelectedTool(tool)}>
                ...
                <div key={day.date} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 h-6 bg-slate-800 rounded-full overflow-hidden relative">
                    ...
                    <div
                      ...
                      style={{ width: `${Math.min((day.errors / day.count) * 100, 100)}%` }}
                    />
                  </div>
